...
public class UnggahanDiterimaActivity extends AppCompatActivity implements UnggahanAdapter.ClickedItem {
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unggahan_diterima);
    ...
    public void getAllUngahanDitinjau() {
        ...
        mApiService.getUnggahanDiterima(idUser).enqueue(new Callback<List<UnggahanResponse>>() {
            @Override
