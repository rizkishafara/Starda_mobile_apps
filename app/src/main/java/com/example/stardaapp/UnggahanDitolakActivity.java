...
public class UnggahanDitolakActivity extends AppCompatActivity implements UnggahanAdapter.ClickedItem {
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unggahan_ditolak);
    ...
    public void getAllUngahanDitinjau() {
        ...
        mApiService.getUnggahanDitolak(idUser).enqueue(new Callback<List<UnggahanResponse>>() {
            @Override
...
//                dialog.dismiss();
    ...
    public void ClickedAlasan(UnggahanResponse unggahanResponse) {
        dialogAlasan(unggahanResponse);
    }

    private void dialogAlasan(UnggahanResponse unggahanResponse) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mContext);

        // set title dialog
        alertDialogBuilder.setTitle("Alasan Unggahan Ditolak");

        // set pesan dari dialog
        alertDialogBuilder
                .setMessage(unggahanResponse.getAlasan())
                .setCancelable(false)
